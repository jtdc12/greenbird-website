    ...
    <nav className="bg-[#1b5e20] text-white shadow-lg sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 65" width="260" height="65">
            {/* Bird */}
            ...
            {/* Divider */}
            <line x1="68" y1="8" x2="68" y2="57" stroke="#4caf50" strokeWidth="1"/>
            {/* Text */}
            <text x="74" y="24" fontSize="15" fontWeight="700" fill="white" fontFamily="Segoe UI, Arial, sans-serif" letterSpacing="0.5">Greenbird</text>
            <text x="74" y="36" fontSize="7.5" fontWeight="400" fill="#a5d6a7" fontFamily="Segoe UI, Arial, sans-serif" letterSpacing="1.5">NETWORK SOLUTIONS</text>
            <text x="75" y="50" fontSize="6.5" fontStyle="italic" fill="#66bb6a" fontFamily="Segoe UI, Arial, sans-serif" letterSpacing="0.3">We handle IT so you can handle business.</text>
          </svg>
        </Link>
